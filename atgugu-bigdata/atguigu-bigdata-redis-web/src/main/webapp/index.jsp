...
<script  src="/redisweb/static/jquery/jquery-3.1.0.js" ></script>
<link href="/redisweb/static/bs/css/bootstrap.min.css" rel="stylesheet" />
<script  src="/redisweb/static/bs/js/bootstrap.min.js"   ></script>
...
$(function(){
	$("#sendCode").click( function () {
		   ...
		   $.post("/redisweb/CodeSenderServlet",$("#codeform").serialize(),function(data){
	    	 if(data=="true"){
	    		 t=120;
	    		 clearInterval(interval);
